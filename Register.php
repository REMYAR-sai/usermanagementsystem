...
/**
Author:Remya R
 function construct inorder to load  libraries and helpers
*/   
...
/**
Author:Remya R
 function index inorder to view registration form
*/ 
 function index()
 {
 ...
 /**
Author:Remya R
 function insertion and validation
*/ 
 ...
 function validation()
 {
 	...
 	$this->form_validation->set_rules('phn_no', 'Phone Number', 'required|numeric|exact_length[10]');
